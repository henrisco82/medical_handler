...
var LoginComponent = (function () {
    function LoginComponent(fb, _loginService) {
        this._loginService = _loginService;
        this.form = fb.group({
            username: ['', forms_1.Validators.required],
            password: ['', forms_1.Validators.compose([forms_1.Validators.required, passwordValidator_1.PasswordValidator.cannotContainSpace])]
        });
    }
